...
const inputClass =
  "w-full rounded-xl border bg-white dark:bg-slate-950 px-3 py-2 " +
      ...
      <form onSubmit={onSubmit} className="max-w-xl space-y-4" noValidate>
        ...
        */}
        ...
        <button
          ...
          className="rounded-2xl bg-slate-900 text-white dark:bg-slate-50 dark:text-slate-900 px-4 py-2.5 text-sm font-semibold hover:opacity-90 disabled:opacity-60 focus:outline-none focus:ring-2 focus:ring-slate-400"
        >
